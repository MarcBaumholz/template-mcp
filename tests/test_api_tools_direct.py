#!/usr/bin/env python3
"""
Direct test script for API tools
Tests the actual functions directly, bypassing MCP wrappers
"""
...
def test_enhanced_rag_analysis():
    ...
    try:
        # Import the actual function from tools.rag_tools
        ...
        print("🔄 Calling analyze_fields_with_rag_and_llm...")
...
async def test_reasoning_agent():
    ...
    try:
        # Import the actual function from tools.reasoning_agent
...
async def main():
    ...
    if overall_success:
        ...
        print("\n📋 SOLUTION:")
        print("   Use the functions directly in your code instead of through MCP:")
        print("   - from tools.rag_tools import analyze_fields_with_rag_and_llm")
        print("   - from tools.reasoning_agent import reasoning_agent")
